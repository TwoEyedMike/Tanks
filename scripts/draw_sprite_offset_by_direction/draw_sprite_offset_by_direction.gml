...
function draw_sprite_offset_by_direction(_sprite, _imageIndex, _direction, _x, _y, _blend, _alpha) {
    ...
    draw_sprite_ext(_sprite, _imageIndex, _x + _xOffset, _y + _yOffset, 1, 1, _direction, _blend, _alpha);
};    